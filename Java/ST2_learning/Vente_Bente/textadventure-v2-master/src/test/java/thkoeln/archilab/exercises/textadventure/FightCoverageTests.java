...
public class FightCoverageTests {
    ...
    @Test
    public void testPlayerMonsterAttack() throws AlreadyBlockedException, CommandException {
        // given: player and monster3 in one corner
        player.place( dungeon.getField( 0, 0 ) );
        monster1.place( dungeon.getField( 0, 1 ) );
    ...
    @Test
    public void testTwoMonsterAttack() throws AlreadyBlockedException {
        // given: two monsters in a corner
        monster1.place( dungeon.getField( 3, 0 ) );
        monster2.place( dungeon.getField( 4, 0 ) );
