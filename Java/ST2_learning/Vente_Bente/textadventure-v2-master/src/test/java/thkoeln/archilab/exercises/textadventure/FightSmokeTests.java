...
public class FightSmokeTests {
    ...
    @Test
    public void testPlayerMonsterFightToDeath() throws AlreadyBlockedException, CommandException {
        // given: player and monster3 in one corner
        player.place( dungeon.getField( 0, 0 ) );
        monster3.place( dungeon.getField( 0, 1 ) );

        // when: player has sword, and there is fight until death: player attacks monster3 / then monster3 attacks player
        dungeon.getField( 0, 0 ).setItem( new Item( "sword", Impact.from( 0f ), Impact.from( -30f ) ) );
    ...
    @Test
    public void testThreeMonsterFightToDeath() throws AlreadyBlockedException {
        // given: three monsters in a corner, like this:
        //  1 3
        //    2
        monster1.place( dungeon.getField( 3, 0 ) );
        monster2.place( dungeon.getField( 4, 1 ) );
        monster3.place( dungeon.getField( 4, 0 ) );
