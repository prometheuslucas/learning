...
public class Vector2D {
     ...
     */
    public static Vector2D fromString(String vector2DString) throws InvalidInputException {
        ...
        return new Vector2D(coordinatePair.getLeft(), coordinatePair.getRight());
    }
